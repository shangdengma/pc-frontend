...
<style scoped>
.customer-finance-page { width: min(1440px, 100%); margin: 0 auto; display: grid; gap: 18px; color: var(--text); }
.back-link { display: inline-flex; align-items: center; gap: 7px; padding: 0; border: 0; color: var(--cinnabar); background: transparent; font: inherit; font-size: var(--fs-sm); font-weight: 700; cursor: pointer; }
...
.customer-summary { min-height: 128px; display: grid; grid-template-columns: minmax(300px, .9fr) minmax(680px, 2fr); overflow: hidden; border: 1px solid var(--line-soft); border-radius: var(--radius); background: #fff; box-shadow: 0 8px 24px rgba(22, 24, 29, .05); }
.customer-identity { display: flex; align-items: center; gap: 15px; padding: 22px 24px; border-right: 1px solid var(--line-soft); background: var(--line-soft); }
.customer-avatar { width: 48px; height: 48px; display: grid; place-items: center; flex: 0 0 auto; border-radius: var(--radius); color: var(--cinnabar); background: var(--line-soft); font-size: var(--fs-xl); font-weight: 800; }
.summary-label { display: block; margin-bottom: 5px; color: var(--text-secondary); font-size: var(--fs-xs); font-weight: 700; }
.customer-identity strong { display: block; color: var(--text); font-size: var(--fs-xl); }
.customer-identity small { display: block; max-width: 360px; margin-top: 6px; overflow: hidden; color: var(--text-secondary); font-size: var(--fs-xs); text-overflow: ellipsis; white-space: nowrap; }
.summary-metrics { display: grid; grid-template-columns: repeat(4, minmax(0, 1fr)); margin: 0; }
.summary-metrics div { display: flex; flex-direction: column; justify-content: center; padding: 20px; border-right: 1px solid var(--line-soft); }
.summary-metrics div:last-child { border-right: 0; }
.summary-metrics dt { margin-bottom: 10px; color: var(--text-secondary); font-size: var(--fs-sm); }
.summary-metrics dd { margin: 0; color: var(--text); font-size: var(--fs-xl); font-weight: 750; font-variant-numeric: tabular-nums; }
...
.summary-loading span { height: 70px; border-radius: var(--radius); background: linear-gradient(90deg, var(--line-soft), var(--line-soft), var(--line-soft)); background-size: 200% 100%; animation: loading 1.4s infinite; }
...
.page-error button, .ledger-error button { border: 0; color: var(--cinnabar); background: transparent; font: inherit; font-weight: 700; cursor: pointer; }

.ledger-workspace { overflow: hidden; border: 1px solid var(--line-soft); border-radius: var(--radius); background: #fff; box-shadow: 0 8px 24px rgba(22, 24, 29, .05); }
.ledger-toolbar { min-height: 76px; display: flex; align-items: center; justify-content: space-between; gap: 24px; padding: 16px 20px; border-bottom: 1px solid var(--line-soft); }
.ledger-toolbar h3 { margin: 0 0 5px; font-size: var(--fs-lg); }
.ledger-toolbar p { margin: 0; color: var(--muted); font-size: var(--fs-sm); }
.ledger-tabs { display: flex; align-items: center; gap: 4px; padding: 4px; border: 1px solid var(--line-soft); border-radius: var(--radius); background: var(--line-soft); }
.ledger-tabs button { height: 34px; display: inline-flex; align-items: center; gap: 7px; padding: 0 13px; border: 0; border-radius: var(--radius); color: var(--text-secondary); background: transparent; font: inherit; font-size: var(--fs-sm); font-weight: 700; cursor: pointer; }
.ledger-tabs button.active { color: var(--cinnabar); background: #fff; box-shadow: 0 1px 4px rgba(22, 24, 29, .1); }
...
.trade-number { overflow: hidden; color: var(--text-secondary); font-family: Consolas, monospace; font-size: var(--fs-xs); text-overflow: ellipsis; white-space: nowrap; }
.empty-row { height: 220px; color: var(--muted) !important; text-align: center; }
.loading-row td { height: 220px; padding: 30px; }
.loading-row span { display: block; height: 72px; border-radius: var(--radius); background: linear-gradient(90deg, var(--line-soft), var(--line-soft), var(--line-soft)); background-size: 200% 100%; animation: loading 1.4s infinite; }
.ledger-pagination { min-height: 66px; display: flex; align-items: center; justify-content: space-between; gap: 20px; padding: 12px 20px; border-top: 1px solid var(--line-soft); color: var(--text-secondary); font-size: var(--fs-sm); }
.ledger-pagination > div { display: flex; align-items: center; gap: 12px; }
.ledger-pagination select, .page-controls button { height: 34px; border: 1px solid var(--line); border-radius: var(--radius); color: var(--text-secondary); background: #fff; font: inherit; }
.ledger-pagination select { padding: 0 30px 0 10px; }
.page-controls button { min-width: 70px; padding: 0 12px; cursor: pointer; }
.page-controls button:hover:not(:disabled) { border-color: var(--line); background: var(--line-soft); }
...
@media (max-width: 1180px) {
  ...
  .customer-identity { border-right: 0; border-bottom: 1px solid var(--line-soft); }
...
@media (max-width: 760px) {
  ...
  .summary-metrics div:nth-child(-n+2) { border-bottom: 1px solid var(--line-soft); }
...
@media (max-width: 768px) {
  ...
  .ledger-table td[data-label="业务流水号"] { grid-area: trade; color: var(--muted); font-size: var(--fs-xs); word-break: break-all; white-space: normal; }
