...
.primary-btn, .secondary-btn, .ghost-btn { min-width: 0; height: 40px; display: inline-flex; align-items: center; justify-content: center; gap: 8px; padding: 0 16px; border-radius: var(--radius); font: inherit; font-weight: 700; cursor: pointer; transition: border-color .16s ease, background .16s ease, transform .16s ease; }
.primary-btn { border: 1px solid var(--blue); color: #fff; background: var(--blue); box-shadow: 0 7px 16px rgba(22, 24, 29, .16); }
.primary-btn:hover { background: var(--blue-dark); }
.secondary-btn, .ghost-btn { border: 1px solid var(--line); color: var(--text-secondary); background: #fff; }
.secondary-btn:hover, .ghost-btn:hover { border-color: var(--line); background: var(--line-soft); }
...
.primary-btn.compact { height: 36px; padding: 0 13px; font-size: var(--fs-sm); box-shadow: none; }
...
.balance-overview div > span { margin-bottom: 7px; font-size: var(--fs-sm); font-weight: 700; }
.balance-overview strong { display: block; font-size: var(--fs-2xl); line-height: 1.1; font-variant-numeric: tabular-nums; }
.balance-overview small { margin-top: 7px; font-size: var(--fs-xs); }
...
.overview-metrics dt { margin-bottom: 10px; color: var(--muted); font-size: var(--fs-sm); }
.overview-metrics dd { margin: 0; color: var(--text); font-size: var(--fs-xl); font-weight: 750; font-variant-numeric: tabular-nums; }
.overview-metrics dd span { margin-left: 4px; color: var(--muted); font-size: var(--fs-xs); font-weight: 600; }
...
.workspace-tabs { height: 58px; display: flex; align-items: stretch; gap: 28px; padding: 0 24px; border-bottom: 1px solid var(--line); background: var(--line-soft); }
.workspace-tabs button { position: relative; display: inline-flex; align-items: center; gap: 8px; padding: 0 2px; border: 0; color: var(--text-secondary); background: transparent; font: inherit; font-size: var(--fs-base); font-weight: 700; cursor: pointer; }
...
.workspace-tabs button > span { min-width: 22px; height: 20px; display: inline-grid; place-items: center; padding: 0 6px; border-radius: var(--radius-lg); color: var(--muted); background: var(--line-soft); font-size: var(--fs-xs); }
.workspace-tabs button.active > span { color: var(--blue); background: var(--line-soft); }
...
.search-box { width: min(380px, 42%); height: 40px; display: flex; align-items: center; gap: 9px; padding: 0 12px; border: 1px solid var(--line); border-radius: var(--radius); color: var(--muted); background: #fff; }
.search-box:focus-within { border-color: var(--line); box-shadow: 0 0 0 3px rgba(22, 24, 29, .1); }
...
.data-table-wrap { overflow: auto; border: 1px solid var(--line-soft); border-radius: var(--radius); }
.data-table { width: 100%; border-collapse: collapse; table-layout: fixed; }
.data-table { min-width: 1080px; }
.data-table th { padding: 12px 14px; border-bottom: 1px solid var(--line-soft); color: var(--text-secondary); background: var(--line-soft); text-align: left; font-size: var(--fs-xs); font-weight: 700; }
.data-table td { padding: 14px; border-bottom: 1px solid var(--line-soft); color: var(--text-secondary); font-size: var(--fs-sm); vertical-align: middle; }
...
.customer-avatar { width: 36px; height: 36px; display: grid; place-items: center; flex: 0 0 auto; border-radius: var(--radius); color: var(--blue); background: var(--line-soft); font-weight: 800; }
...
.customer-cell strong { color: var(--text); font-size: var(--fs-base); }
.customer-cell small { margin-top: 4px; color: var(--muted); font-size: var(--fs-xs); }
.money-value { color: var(--text) !important; font-weight: 700; font-variant-numeric: tabular-nums; }
.row-actions { text-align: right; white-space: nowrap; }
.row-actions button { padding: 5px 7px; border: 0; color: var(--text-secondary); background: transparent; font: inherit; font-size: var(--fs-sm); font-weight: 700; cursor: pointer; }
...
.status-pill.off { color: var(--muted); background: var(--line-soft); }
...
.icon-actions button { width: 32px; height: 32px; display: inline-grid; place-items: center; margin-left: 3px; border: 1px solid transparent; border-radius: var(--radius); color: var(--text-secondary); background: transparent; cursor: pointer; }
.icon-actions button:hover { border-color: var(--line); color: var(--blue); background: var(--line-soft); }
.pagination-bar { min-height: 48px; display: flex; align-items: center; justify-content: space-between; gap: 16px; padding-top: 14px; color: var(--text-secondary); font-size: var(--fs-xs); }
.pagination-bar > div { display: flex; align-items: center; gap: 9px; }
.pagination-bar button { height: 32px; padding: 0 12px; border: 1px solid var(--line); border-radius: var(--radius); color: var(--text); background: #fff; font: inherit; font-weight: 700; cursor: pointer; }
.pagination-bar button:hover:not(:disabled) { border-color: var(--line); color: var(--blue); background: var(--line-soft); }
...
.empty-state strong { color: var(--text-secondary); font-size: var(--fs-base); }
...
.notice-tip { margin-bottom: 18px; padding: 12px 14px; border-left: 3px solid var(--blue); color: var(--text); background: var(--line-soft); font-size: var(--fs-sm); line-height: 1.6; }
.form-grid { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 18px 20px; }
.form-grid.single-column { grid-template-columns: 1fr; }
.form-grid label { display: grid; gap: 8px; color: var(--text-secondary); font-size: var(--fs-sm); font-weight: 700; }
.form-grid input { min-width: 0; height: 44px; padding: 0 13px; border: 1px solid var(--line); border-radius: var(--radius); outline: none; color: var(--text); background: #fff; font: inherit; }
.form-grid input:focus, .money-input:focus-within { border-color: var(--line); box-shadow: 0 0 0 3px rgba(22, 24, 29, .1); }
.money-input { height: 44px; display: flex; align-items: center; border: 1px solid var(--line); border-radius: var(--radius); background: #fff; }
.money-input b { padding-left: 13px; color: var(--text-secondary); font-size: var(--fs-base); }
.money-input input { flex: 1; border: 0; box-shadow: none !important; }
.form-message { margin: 14px 0 0; padding: 11px 13px; border: 1px solid #ffd2cf; border-radius: var(--radius); color: #c43227; background: #fff4f3; font-size: var(--fs-sm); }
...
.allocation-summary > svg { color: var(--muted); }
.allocation-summary div { padding: 14px; border: 1px solid var(--line-soft); border-radius: var(--radius); background: var(--line-soft); }
.allocation-summary span { display: block; margin-bottom: 7px; color: var(--text-secondary); font-size: var(--fs-xs); }
.allocation-summary strong { font-size: var(--fs-xl); font-variant-numeric: tabular-nums; }
.allocation-hint { margin: 14px 0 0; color: var(--text-secondary); font-size: var(--fs-xs); line-height: 1.6; }
